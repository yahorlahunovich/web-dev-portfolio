...
const Button = ({ link, name }: ButtonProps) => {
  return (
    <a
      href={link}
      target="_blank"
      className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-white transition duration-300 ease-out border-2 border-white rounded-full shadow-md group text-sm sm:text-lg"
    >
