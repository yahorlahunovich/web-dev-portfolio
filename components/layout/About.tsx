...
const About = () => {
  return (
    <section
      id="about"
      className="flex flex-col justify-center items-center text-3xl gap-11 min-h-screen snap-start py-32 pr-32"
      data-aos="fade-up"
    >
      <div className="flex flex-row justify-center items-center">
        ...
        <div className="w-1/2 text-xl leading-8 tracking-wider">
          ...
          <p>
            ...
            making each one unique and original. I also adore studying
            everything related to computer science and computer technologies.
          </p>
          <p>
